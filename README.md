...
- Linux support has arrived! Click [here](https://github.com/rmcvxzzs-stuffs/terram4kc/wiki/Running-(on-linux)) for instructions on how to run it (Libaries haven't been linked into the actual game so you need to install the libraries manually to your system. Again, im sorry.)
- I forgot to change the version name on v0.1.5. (Again 2, im sorry.)
...
- Check [SCREENSHOTS.md](./SCREENSHOTS.MD) to give you a look on TerraM4KC before you consider downloading it or even contributing it!
